  ...
  let Day = React.createClass({
    ...
    render() {
      ...
      if (this.props.filler) {
        ...
        return (
          <TouchableOpacity onPress={this._dateSelection.bind(this, newDay)}>
  ...
  let Calendar = React.createClass({
    ...
    _handleDateSelection(date) {
      ...
      this.props.onDateSelect && this.props.onDateSelect(moment(date).format());
    },
        ...
        for (var j = 0; j < MAX_ROWS; j++) {
          if (preFiller < offset) {
            ...
            if(currentDay < daysInMonth) {
              ...
              days.push((
                <Day
                  onDateSelect={this._handleDateSelection}
    ...
    render() {
      ...
      return (
        <View style={this.styles.calendarContainer}>
          {this._renderTopBar()}
          {this._renderHeading(this.props.titleFormat)}
          <ScrollView
            ref='calendar'
            horizontal={true}
